...
#property version   "2.00" // Added fully customizable lines
...
int OnCalculate(const int rates_total, const int, const datetime&[], const double &open[], const double &high[], const double &low[], const double &close[], const long&[], const long&[], const int&[])
  {
   ...
   g_calculator.Calculate(rates_total, price_type, open, high, low, close, BufferMA1, BufferMA2, BufferMA3, BufferMA4);
   return(rates_total);
  }
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
