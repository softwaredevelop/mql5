...
#property version   "1.00" // Fully functional dynamic Multi-Timeframe V-Score (VWAP Z-Score) with flat-force step-alignment
#property description "Professional Multi-Timeframe (MTF) V-Score Oscillator with dynamic Signal Line."
#property description "Displays HTF V-Score cleanly directly on lower TF charts without live-bar warping."
...
//--- Buffers
double    BufferVScore_MTF[];
double    BufferColors_MTF[];
double    BufferSignal_MTF[];

//--- Internal HTF Data Caches
double    h_res_vscore[]; // HTF VScore Results cached
...
CVScoreCalculator        *g_calculator;
...
//--- 5. Set Shortname
   ...
   string name = StringFormat("V-Score Pro%s(%d)", tf_str, InpPeriod);
   string short_name = "";
