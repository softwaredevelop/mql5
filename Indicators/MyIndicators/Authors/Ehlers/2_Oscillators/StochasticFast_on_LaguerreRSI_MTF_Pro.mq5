...
#property version   "1.00" // Dynamic Multi-Timeframe Fast Stochastic on Laguerre RSI with flat-force step-alignment
...
//--- 4. Set Shortname
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("StochFast on LagRSI%s%s(%.2f, %d, %d)", type, tf_str, InpGamma, InpKPeriod, InpDPeriod));
