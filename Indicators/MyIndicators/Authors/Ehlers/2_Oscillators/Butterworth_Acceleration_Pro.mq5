//+------------------------------------------------------------------+
//|                                  Butterworth_Acceleration_Pro.mq5|
//|                                          Copyright 2026, xxxxxxxx|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, xxxxxxxx"
#property version   "1.00" // First unified Standard & MTF Butterworth Acceleration release
#property description "Acceleration (2nd derivative) of John Ehlers' Higher-Order Butterworth Filter."
...
//--- Plot 1: Butterworth Acceleration (Color Histogram)
#property indicator_label1  "Butterworth Accel"
...
#include <MyIncludes\Butterworth_Acceleration_Calculator.mqh>
...
CButterworthAccelerationCalculator *g_calculator;
...
//--- 3. Initialize Physical Acceleration Calculator
   g_calculator = new CButterworthAccelerationCalculator();
   if(CheckPointer(g_calculator) == POINTER_INVALID || !g_calculator.Init(InpPeriod, InpPoles, is_ha))
     {
      Print("Critical Error: Failed to create or initialize Butterworth Acceleration Calculator.");
      return(INIT_FAILED);
     }
...
//--- 5. Dynamic Setup of Indicator Shortname and Plots
   ...
   string short_name = StringFormat("Butterworth Accel%s%s(%d, P%d)%s",
                                    is_ha ? " HA" : "",
                                    tf_str,
                                    InpPeriod,
                                    (int)InpPoles,
   ...
   if(htf_updated || prev_calculated == 0)
     {
      ...
      //--- Calculate HTF core Butterworth Acceleration
