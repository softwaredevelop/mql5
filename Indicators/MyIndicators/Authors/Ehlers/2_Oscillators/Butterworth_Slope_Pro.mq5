//+------------------------------------------------------------------+
//|                                         Butterworth_Slope_Pro.mq5|
//|                                          Copyright 2026, xxxxxxxx|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, xxxxxxxx"
#property version   "1.00" // First unified Standard & MTF Butterworth Slope release
#property description "Slope derivative of John Ehlers' Higher-Order Butterworth Filter."
...
//--- Plot 1: Butterworth Slope (Color Histogram)
#property indicator_label1  "Butterworth Slope"
...
CButterworthSlopeCalculator *g_calculator;
...
//--- 3. Initialize Physical Slope Calculator
   g_calculator = new CButterworthSlopeCalculator();
   if(CheckPointer(g_calculator) == POINTER_INVALID || !g_calculator.Init(InpPeriod, InpPoles, is_ha))
     {
      Print("Critical Error: Failed to create or initialize Butterworth Slope Calculator.");
      return(INIT_FAILED);
     }
...
//--- 5. Dynamic Setup of Indicator Shortname and Plots
   ...
   string short_name = StringFormat("Butterworth Slope%s%s(%d, P%d)%s",
                                    is_ha ? " HA" : "",
                                    tf_str,
                                    InpPeriod,
                                    (int)InpPoles,
   ...
   if(htf_updated || prev_calculated == 0)
     {
      ...
      //--- Calculate HTF core Butterworth Slope
