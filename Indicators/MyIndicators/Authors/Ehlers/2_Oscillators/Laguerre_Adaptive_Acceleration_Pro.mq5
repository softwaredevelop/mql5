//+------------------------------------------------------------------+
//|                               Laguerre_Adaptive_Acceleration_Pro.mq5|
//|                                          Copyright 2026, xxxxxxxx|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, xxxxxxxx"
#property version   "1.00" // Unified Standard & MTF Adaptive Acceleration release
#property description "Acceleration (2nd derivative) of John Ehlers' Adaptive Laguerre Filter."
#property description "Features dynamic ER/ATR/StDev adaptive paths with 5-zone thermal coloring."

#property indicator_separate_window
#property indicator_buffers 3
#property indicator_plots   2

//--- Plot 1: Adaptive Acceleration (Color Histogram)
#property indicator_label1  "Adaptive Accel"
...
#include <MyIncludes\Laguerre_Adaptive_Acceleration_Calculator.mqh>
...
CLaguerreAdaptiveAccelerationCalculator *g_calculator;
...
//--- 3. Initialize Physical Adaptive Accel Calculator
   g_calculator = new CLaguerreAdaptiveAccelerationCalculator();
   if(CheckPointer(g_calculator) == POINTER_INVALID || !g_calculator.Init(InpAdaptiveMethod, InpAdaptivePeriod, InpGammaMin, InpGammaMax, is_ha))
     {
      Print("Critical Error: Failed to create or initialize Adaptive Accel Calculator.");
      return(INIT_FAILED);
     }
...
//--- 5. Dynamic Setup of Indicator Shortname and Plots
   ...
   string short_name = StringFormat("Laguerre Adaptive Accel%s%s(%s, %d, %.2f-%.2f)%s",
                                    is_ha ? " HA" : "",
                                    tf_str,
                                    method_str,
                                    InpAdaptivePeriod,
...
//--- Drawing offset configuration
   int draw_begin = InpAdaptivePeriod * 2 + InpSignalPeriod + 6;
   if(g_is_mtf_mode)
   ...
   if(htf_updated || prev_calculated == 0)
     {
      ...
      //--- Calculate HTF core Adaptive Accel
   ...
   if(live_idx >= required_bars)
     {
      ...
      if(shift >= 0 &&
         ...
         CopyClose(_Symbol, g_calc_timeframe, shift, 1, c) == 1)
        {
         ...
         // Stateful, O(1) mock update for the live HTF sáv
