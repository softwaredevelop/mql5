//+------------------------------------------------------------------+
//|                                      Ehlers_Smoother_Slope_Pro.mq5|
//|                                          Copyright 2026, xxxxxxxx|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, xxxxxxxx"
#property version   "1.00" // First unified Standard & MTF Ehlers Smoother Slope release
#property description "Slope derivative of John Ehlers' SuperSmoother and UltimateSmoother."
#property description "Features standard & MTF support with a 5-zone momentum color palette."

#property indicator_separate_window
#property indicator_buffers 3
#property indicator_plots   2

//--- Plot 1: Smoother Slope (Color Histogram)
#property indicator_label1  "Smoother Slope"
...
#include <MyIncludes\Ehlers_Smoother_Slope_Calculator.mqh>
...
CEhlersSmootherSlopeCalculator *g_calculator;
...
//--- 3. Initialize Physical Slope Calculator
   g_calculator = new CEhlersSmootherSlopeCalculator();
   if(CheckPointer(g_calculator) == POINTER_INVALID || !g_calculator.Init(InpPeriod, InpSmootherType, is_ha))
     {
      Print("Critical Error: Failed to create or initialize Ehlers Smoother Slope Calculator.");
      return(INIT_FAILED);
     }
...
//--- 5. Dynamic Setup of Indicator Shortname and Plots
   ...
   string short_name = StringFormat("%sSmoother Slope%s%s(%d)%s",
                                    type_name,
                                    is_ha ? " HA" : "",
                                    tf_str,
                                    InpPeriod,
   ...
   if(htf_updated || prev_calculated == 0)
     {
      ...
      //--- Calculate HTF core Ehlers Smoother Slope
