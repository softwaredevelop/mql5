//+------------------------------------------------------------------+
//|                              Laguerre_Filter_Adaptive_MTF_Pro.mq5|
//|                                     Copyright 2025, xxxxxxxx     |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, xxxxxxxx"
#property version   "1.00"
#property description "Multi-Timeframe (MTF) John Ehlers' Adaptive Laguerre Filter."

#property indicator_chart_window
#property indicator_buffers 1
#property indicator_plots   1
#property indicator_label1  "Adaptive Laguerre MTF"
...
// Initialize
   if(CheckPointer(g_calculator) == POINTER_INVALID || !g_calculator.Init())
     {
      Print("Failed to initialize Adaptive Laguerre Calculator.");
      return(INIT_FAILED);
     }
...
//--- 4. Set Shortname
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("Adaptive Laguerre%s%s", type, tf_str));

// Draw begin logic (approximate for MTF)
   int draw_begin = 10; // Needs warmup
   if(g_is_mtf_mode)
      draw_begin = 0;
...
//--- E. Calculate HTF Adaptive Laguerre (Incremental)
