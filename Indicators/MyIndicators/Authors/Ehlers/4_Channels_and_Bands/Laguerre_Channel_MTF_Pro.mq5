...
//--- 3. Initialize Calculator
   ...
   if(CheckPointer(g_calculator) == POINTER_INVALID ||
     ...
     {
      Print("Failed to create or initialize Laguerre Channel Calculator object.");
      return(INIT_FAILED);
     }
   ...
   if(htf_updated || prev_calculated == 0)
     {
      ...
      //--- Calculate Laguerre Channel on HTF (Closed bars and forming bar initialized)
