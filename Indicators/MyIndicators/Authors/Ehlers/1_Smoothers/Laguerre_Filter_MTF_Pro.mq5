...
//--- E. Calculate HTF Laguerre (Incremental)
// Step back 1 bar to ensure the open candle is always updated
   ...
   g_calculator.CalculateFilter(htf_rates_total, htf_calc_start, price_type,
