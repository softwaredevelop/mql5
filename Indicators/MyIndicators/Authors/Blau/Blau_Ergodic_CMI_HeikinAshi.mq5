//+------------------------------------------------------------------+
//|                                 Blau_Ergodic_CMI_HeikinAshi.mq5  |
...
#property description "Ergodic Candle Momentum Index (CMI) on Heikin Ashi data."
...
#property indicator_label1  "HA_Ergodic_CMI"
...
int OnInit()
  {
   ...
   int cmi_draw_begin = g_ExtSlowPeriod + g_ExtFastPeriod -1;
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("HA_Ergodic_CMI(%d,%d,%d)", g_ExtSlowPeriod, g_ExtFastPeriod, g_ExtSignalPeriod));
...
//+------------------------------------------------------------------+
//| Ergodic CMI on Heikin Ashi calculation function.                 |
//+------------------------------------------------------------------+
...
//--- STEP 5: Calculate final CMI value
   for(int i = ema2_start_pos; i < rates_total; i++)
     {
