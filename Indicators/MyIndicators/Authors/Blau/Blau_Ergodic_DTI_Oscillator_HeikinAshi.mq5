//+------------------------------------------------------------------+
//|                          Blau_Ergodic_DTI_Oscillator_HeikinAshi.mq5|
...
#property description "Ergodic DTI Oscillator on Heikin Ashi data"
...
#property indicator_label1  "HA_DTI_Osc"
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("HA_Ergodic_DTI_Osc(%d,%d,%d,%d)", g_ExtMomentumPeriod, g_ExtSlowPeriod, g_ExtFastPeriod, g_ExtSignalPeriod));
...
//+------------------------------------------------------------------+
//| Ergodic DTI Oscillator on Heikin Ashi calculation function.      |
//+------------------------------------------------------------------+
...
//--- STEP 5: Calculate final DTI value (internal buffer)
   double buffer_dti[];
