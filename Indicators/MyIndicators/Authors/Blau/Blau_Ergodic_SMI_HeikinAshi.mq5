//+------------------------------------------------------------------+
//|                                Blau_Ergodic_SMI_HeikinAshi.mq5   |
...
#property description "Ergodic SMI on Heikin Ashi data, with a signal line."
...
#property indicator_label1  "HA_Ergodic_SMI"
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("HA_Ergodic_SMI(%d,%d,%d)", g_ExtStochPeriod, g_ExtSlowPeriod, g_ExtFastPeriod));
...
//+------------------------------------------------------------------+
//| Ergodic SMI on Heikin Ashi calculation function.                 |
//+------------------------------------------------------------------+
...
//--- STEP 5: Calculate final SMI value
   for(int i = ema2_start_pos; i < rates_total; i++)
     {
      if(ema2_range[i] != 0)
        {
