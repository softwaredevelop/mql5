//+------------------------------------------------------------------+
//|                                   StochAdaptive_on_RSI_Pro.mq5   |
//|                                          Copyright 2026, xxxxxxxx|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, xxxxxxxx"
#property version   "4.00" // Renamed and Optimized
#property description "Adaptive Stochastic applied to Standard RSI."
#property description "Dynamically adjusts Stochastic period based on market Efficiency Ratio (ER)."
...
#include <MyIncludes\StochAdaptive_on_RSI_Calculator.mqh>
...
CStochAdaptiveOnRSICalculator *g_calculator;
...
int OnInit()
  {
   ...
   if(InpSourcePrice <= PRICE_HA_CLOSE)
      g_calculator = new CStochAdaptiveOnRSICalculator_HA();
   else
      g_calculator = new CStochAdaptiveOnRSICalculator();
   ...
   if(CheckPointer(g_calculator) == POINTER_INVALID ||
     ...
     {
      Print("Failed to create or initialize Calculator.");
      return(INIT_FAILED);
     }

   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("StochAdaptive on RSI%s", (InpSourcePrice <= PRICE_HA_CLOSE ? " HA" : "")));
