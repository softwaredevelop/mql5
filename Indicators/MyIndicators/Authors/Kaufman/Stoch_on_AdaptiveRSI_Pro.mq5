//+------------------------------------------------------------------+
//|                                   Stoch_on_AdaptiveRSI_Pro.mq5   |
//|                                          Copyright 2026, xxxxxxxx|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, xxxxxxxx"
#property version   "1.00"
#property description "Stochastic Oscillator applied to Adaptive RSI (Professional Edition)."
...
#include <MyIncludes\Stoch_on_AdaptiveRSI_Calculator.mqh>
...
CStochOnAdaptiveRSICalculator *g_calculator;
...
int OnInit()
  {
   ...
   if(InpSourcePrice <= PRICE_HA_CLOSE)
      g_calculator = new CStochOnAdaptiveRSICalculator_HA();
   else
      g_calculator = new CStochOnAdaptiveRSICalculator();
   ...
   if(CheckPointer(g_calculator) == POINTER_INVALID ||
     ...
     {
      Print("Failed to initialize Stoch on AdaptiveRSI Calculator.");
      return(INIT_FAILED);
     }

   IndicatorSetString(INDICATOR_SHORTNAME, StringFormat("StochAdaptiveRSI%s(%d)", (InpSourcePrice <= PRICE_HA_CLOSE ? " HA" : ""), InpPivotalPeriod));
